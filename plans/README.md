...
| [MIDI controller support](midi-control.md) | (net-new) | **Plugin** | 🟡 Med | not started (Draft). ⛔ **HELD by the documentation gate** — it is the next net-new feature |
