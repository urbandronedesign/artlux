...
3. **Every other panel is fed the global `timeline` while you edit a scene's** ([App.tsx:1752, 1888, 1973, 2132](../src/renderer/App.tsx#L1752)) — so the Cues panel enumerates the wrong layers. Feed them `activeTimeline`.
