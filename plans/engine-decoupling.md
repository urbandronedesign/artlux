...
`npm run verify` is green at 53 checks; nothing has been pushed. As of 2026-07-27.
...
**The best next code task**, with a number attached: **switching workspace context costs 96 ms/s** of
React commit time (measured 2026-07-27 as the positive control for WP-0.5). That is now the largest
remaining UI cost, and unlike the timeline's it is at least paid for a real event — a person changed
what is on screen. Whether it is worth attacking is a judgement call, not an obvious yes.
**Idle cost is gone: the editor now sits at 0.0 ms/s** (WP-0.5 — it was 177–224).
